...
public class LoginTest extends BaseTest {
    ...
    @Story("Test Case Id: L001  - verification of test log in functinality")
    ...
    public Object[][] getData() {
        return new Object[][]{
                ...
                {"withuppercase","di-admin@neutrinotechsystems.com","qwerfgdt"},
                {"withlowercase","di-admin@neutrinotechsystems.com","ASDFGHJK"},
                {"onlydigit","di-admin@neutrinotechsystems.com","12345678"},

        };
    }
    @Severity(SeverityLevel.CRITICAL)
    @Story("Test Case Id: L002  - verification of title logo and login with blank details")
    ...
    @Severity(SeverityLevel.CRITICAL)
    @Story("Test Case Id: L003  - verify that the user is able to Log off the application")
    ...
    @Story("Test Case Id: For004 - verify click on cancel button on forgot password")
    ...
    @Severity(SeverityLevel.NORMAL)
    @Story("Test Case Id: For005 - verify forgot password  email textfield functinality")
    ...
    @Severity(SeverityLevel.NORMAL)
    @Story("Test Case Id: For006 - verify_forgot_password_Functinality_When_User_Is_Disable")
    ...
    @Severity(SeverityLevel.NORMAL)
    @Story("Test Case Id: For007 - verify click on cancel button on forgot password")
    @Description("verify user able to click_on_cancel_button_on_forgot_password")
    ...
    @Severity(SeverityLevel.NORMAL)
    @Story("Test Case Id: For008 - verify click on cancel button on forgot password")
    @Description("verify user able to click_on_cancel_button_on_forgot_password")
