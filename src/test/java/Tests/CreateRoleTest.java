...
Thread.sleep(2000);
        ...
        Thread.sleep(3000);
      createRolePage.checkNavigateRightLeft();
    }
...
@Story("story_id: C16 - verify_total_count_and_navigate_right_left_arrow")
@Description("verify_total_count_and_navigate_right_left_arrow")
@Test(priority = 19, groups = "smoke", description = "verify_total_count_and_navigate_right_left_arrow(")
public void verify_total_count_and_navigate_right_left_arrow() throws Exception {
    createRolePage = new CreateRolePage(driver);
    clickOnOutSide = new ClickOnOutSide(driver);
    custom = new Custome_Wait(driver);
    softAssert = new SoftAssert();
    ...
    driver.findElement(By.xpath("//mat-icon[contains(text(),' list ')]")).click();
    Thread.sleep(3000);
    createRolePage.getTotalUserCountOfItemPerPage();
    Thread.sleep(1000);
...
//for create role
//    @Severity(SeverityLevel.NORMAL)
//    @Story("story_id: C020 - verifyRoleWithDisbaleToggleButton")
//    @Description("verifyRoleWithDisbaleToggleButton")
//    @Test(priority = 20, groups = "smoke", description = "verifyRoleWithDisbaleToggleButton")
//    public void verifyRoleWithDisbaleToggleButton() throws Exception {
//        createRolePage = new CreateRolePage(driver);
//        clickOnOutSide = new ClickOnOutSide(driver);
//        softAssert = new SoftAssert();
//        custom = new Custome_Wait(driver);
...
//        createRolePage.clickCreateRoleBtn();
//        waitForloadSpinner();
//        createRolePage.entervalidRoleName("QAtest");
//        createRolePage.addPermission();
//        custom.waitVisibility(driver, driver.findElement(By.xpath("//button[contains(text(),' Role')]")));
//        createRolePage.roleOption();
//        custom.waitVisibility(driver, driver.findElement(By.xpath("//div[contains(text(),' View Role')]")));
...
//    }
    ...
    @Severity(SeverityLevel.NORMAL)
    @Story("story_id: C020 - verifyRoleWithInvalidrolename")
    @Description("verifyRoleWithInvalidrolename")
    @Test(priority = 20, groups = "smoke", description = "verifyRoleWithInvalidrolename")
    public void verifyRoleWithInvalidrolename() throws Exception {
        createRolePage = new CreateRolePage(driver);
        clickOnOutSide = new ClickOnOutSide(driver);
        softAssert = new SoftAssert();
        custom = new Custome_Wait(driver);
        ...
        createRolePage.clickCreateRoleBtn();
        waitForloadSpinner();
        createRolePage.entervalidRoleName("@@#%%");
            Thread.sleep(1000);
    createRolePage.activateButton();
        Thread.sleep(1000);
        createRolePage.addPermission();
        ...
        waitForloadSpinner();
        softAssert.assertEquals(driver.findElement(By.xpath("//mat-error[contains(text(),'Only alphabets,digits,parenthesis and hyphens are allowed.')]")).getText(), "Only alphabets,digits,parenthesis and hyphens are allowed.");
        softAssert.assertEquals(driver.findElement(By.xpath("//simple-snack-bar[@class=\"mat-simple-snackbar ng-star-inserted\"]")).getText(),"Please enter all the details for creating a role.");
        softAssert.assertAll();
    ...
    //for create role
//    @Severity(SeverityLevel.NORMAL)
//    @Story("story_id: C022 - verify that user is able to create new role ")
//    @Description("verify_that_user_is_able_to_create_new_role")
//    @Test(priority = 22, groups = "smoke", description = "verify_that_user_is_able_to_create_new_role")
...
//        createRolePage.clickCreateRoleBtn();
//        waitForloadSpinner();
//        createRolePage.EnterNewRoleName("qatest");
//        createRolePage.activateButton();
//        Thread.sleep(1000);
//        createRolePage.addPermission();
//        createRolePage.roleOption();
...
//        createRolePage.clickCreateRoleBtn();
//        waitForloadSpinner();
//        createRolePage.EnterNewRoleName("Test-Me");
//        createRolePage.activateButton();
//        Thread.sleep(1000);
//        createRolePage.addPermission();
//        createRolePage.roleOption();
...
//        softAssert.assertAll();}
    ...
    @Severity(SeverityLevel.NORMAL)
    @Story("story_id: C022 - verify that user is able to create new role with invalid value ")
    @Description("verify that user is able to create new role with invalid value ")
    @Test(priority = 22, groups = "smoke", description = "verify that user is able to create new role with invalid value ")
    public void verifyCreateNewRoleWithInvalidValue() throws Exception {
        createRolePage = new CreateRolePage(driver);
        clickOnOutSide = new ClickOnOutSide(driver);
        softAssert = new SoftAssert();
        custom = new Custome_Wait(driver);
        ...
        createRolePage.clickCreateRoleBtn();
        waitForloadSpinner();
        createRolePage.EnterNewRoleName("QA_AUTOMATION123");
        createRolePage.activateButton();
        Thread.sleep(1000);
        createRolePage.addPermission();
        createRolePage.roleOption();
    ...
    @Story("story_id:U021-verify text on UI Role Page")
    @Description("Verify text present on UI Role Page")
    @Test(priority = 21, groups = "smoke", description = "verify text on UI Role Page")
    public void verifyUITextOnRolePage() throws Exception {
        createRolePage = new CreateRolePage(driver);
        softAssert = new SoftAssert();
        waitForloadSpinner();
        createRolePage.clickRoleBtn();
        waitForloadSpinner();
        softAssert.assertEquals(driver.findElement(By.xpath("//strong[@class='primary-font-color']")).getText(), "List of Roles");
        softAssert.assertEquals(driver.findElement(By.xpath("//button[contains(@class,'mat-focus-indicator font-17 float-right ')]")).getText(), "Create Role");
        Thread.sleep(3000);
        createRolePage.clickOnGridListButton();
        createRolePage.getTheTextOfListOfRoles();
        ...
        createRolePage.clickOnEditButton();
        softAssert.assertEquals(driver.findElement(By.xpath("//strong[@class='primary-font-color']")).getText(), "Edit Role");
        createRolePage.getTextOfEditRole();
        softAssert.assertEquals(driver.findElement(By.xpath("//h6[contains(text(),'Permissions')]")).getText(), "Permissions");
        softAssert.assertEquals(driver.findElement(By.xpath("//button[contains(@class,'mat-focus-indicator mat-menu-trigger ')]")).getText(), "Add permission add_circle_outline");
        createRolePage.clickOnCancelButton();
        Thread.sleep(3000);
        createRolePage.clickCreateRoleBtn();
        softAssert.assertEquals(driver.findElement(By.xpath("//strong[@class='primary-font-color']")).getText(), "Create Role");
        createRolePage.getTextOfCreateCancelBtn();
        softAssert.assertEquals(driver.findElement(By.xpath("//strong[@class='primary-font-color']//following::mat-label[1]")).getText(), "Role Name *");
        softAssert.assertEquals(driver.findElement(By.xpath("//strong[@class='primary-font-color']//following::mat-label[2]")).getText(), "Active Role");
        softAssert.assertEquals(driver.findElement(By.xpath("//h6[contains(text(),'Permissions')]")).getText(), "Permissions");
        softAssert.assertEquals(driver.findElement(By.xpath("//button[contains(@class,'mat-focus-indicator mat-menu-trigger ')]")).getText(), "Add permission add_circle_outline");
        softAssert.assertAll();
    }
