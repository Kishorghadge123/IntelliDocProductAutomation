...
//    }
    ...
    public void to_Verify_Target_Count() throws Exception {
        ...
        Thread.sleep(2000);
        s.ScrollUpDown(driver.findElement(By.xpath("(//mat-icon[contains(text(),'delete')])[1]")));
       project.deletePd();
       Thread.sleep(1000);
    ...
    public void to_Verify_Add_Entity_Options() throws Exception {
        softAssert = new SoftAssert();
        s=new Scroll_Page(driver);
        docobj=new DocumentPage(driver);
        custom=new Custome_Wait(driver);
        ...
        userPage.searchProjectInUserPage("pratikshamedicaloperator");
        Thread.sleep(2000);
    ...
    public void verifySaveDraftFunctionalityWithEditingComment() throws Exception {
        ...
        Thread.sleep(1000);
        medobj.clickHeaderDropdown();
        Thread.sleep(1000);
        medobj.clickCommentDropdown();
        Thread.sleep(1000);
        medobj.clickHeaderDropdown();
        Thread.sleep(2000);
    ...
    @Test(priority = 10, groups = "smoke", description = "verifyDeleteEncounterFunctionality")
...
docobj.enterPageNumber("1");
        ...
        docobj.clickOnHcc("111");
        docobj.clickOnHCCSaveBtn();
        softAssert.assertEquals(driver.findElement(By.xpath("//simple-snack-bar[@class=\"mat-simple-snackbar ng-star-inserted\"]")).getText(),"This ICD has been entered once, please enter a different ICD.");
    softAssert.assertAll();
    }
