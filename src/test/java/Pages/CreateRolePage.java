...
//TC 6.1 element locators
    ...
    @FindBy(xpath = "//button[contains(@class,'mat-focus-indicator font-17 mat')]")
    ...
    public By CancelBtn1 = By.xpath("(//span[contains(text(),'Cancel')])[2]");
...
//        this.SearchRole.click();
    ...
    public void getTheTextOfListOfRoles() {
        ...
        softAssert.assertEquals(getTheTableHeaderText.get(1).getText(), "Permissions");
        softAssert.assertEquals(getTheTableHeaderText.get(2).getText(), "Updated Date");
        softAssert.assertEquals(getTheTableHeaderText.get(3).getText(), "Created Date");
    }

    @Step("Click on grid List")
    public void clickOnGridListButton() {
        this.gridButton.click();
    }

    public void getTextOfCreateCancelBtn() {
        List<WebElement> getTheTableHeaderText = driver.findElements(By.xpath("//button[contains(@class,'mat-focus-indicator float-right')]"));
    ...
    public void getTextOfEditRole() {
        List<WebElement> getTheTableHeaderText = driver.findElements(By.xpath("//input[contains(@class,'mat-input-element mat-form-field-autofill-control ')]//following::mat-label"));
        softAssert.assertEquals(getTheTableHeaderText.get(0).getText(), "Role Name *");
        softAssert.assertEquals(getTheTableHeaderText.get(1).getText(), "Created");
        softAssert.assertEquals(getTheTableHeaderText.get(1).getText(), "Updated");
        softAssert.assertEquals(getTheTableHeaderText.get(1).getText(), "Active Role");
    }
